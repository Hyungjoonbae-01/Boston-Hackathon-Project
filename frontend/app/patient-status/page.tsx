  ...
  return (
    <div className="min-h-screen bg-slate-800 dark:bg-slate-800 text-white">
      ...
      <div className="p-5 pt-16">
        ...
        {/* Route Visualization */}
        <div className="h-52 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-2xl mb-5 relative overflow-hidden">
          <div className="absolute inset-4 border-2 border-dashed border-white/30 rounded-2xl"></div>
        ...
        <div className="grid grid-cols-1 gap-3 mb-5">
          <div className="bg-slate-700 p-4 rounded-2xl flex items-center">
            <div className="w-10 h-10 bg-slate-600 rounded-xl flex items-center justify-center mr-3">🏥</div>
            <div>
              <div className="text-xs opacity-70">Destination</div>
              <div className="font-semibold">{selectedHospital || "City General Hospital"}</div>
            </div>
          </div>

          <div className="grid grid-cols-2 gap-3">
            <div className="bg-slate-700 p-4 rounded-2xl flex items-center">
              <div className="w-10 h-10 bg-slate-600 rounded-xl flex items-center justify-center mr-3 text-lg">⏱️</div>
              <div>
                <div className="text-xs opacity-70">ETA</div>
                <div className="font-semibold">{currentETA} minutes</div>
              </div>
            </div>

            <div className="bg-slate-700 p-4 rounded-2xl flex items-center">
              <div className="w-10 h-10 bg-slate-600 rounded-xl flex items-center justify-center mr-3 text-lg">📏</div>
              <div>
                <div className="text-xs opacity-70">Distance</div>
                <div className="font-semibold">2.3 miles</div>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* ETA Highlight */}
        <div className="bg-green-500 p-5 rounded-2xl text-center mb-5 shadow-lg">
        ...
        <div className="bg-slate-700 p-5 rounded-2xl mb-20">
          <div className="mb-5">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium">{patientData.patientName || "Not Applicable"}</span>
              </div>
              <div className="flex justify-between">
                <span className="opacity-70">Age:</span>
                <span className="font-medium">{patientData.ageRange || "36-50"} years</span>
              </div>
              <div className="flex justify-between">
                <span className="opacity-70">Gender:</span>
                <span className="font-medium capitalize">{patientData.gender || "Male"}</span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-slate-800 p-3 rounded-xl flex items-center">
                <div className="w-9 h-9 bg-slate-600 rounded-lg flex items-center justify-center mr-3">❤️</div>
                <div>
                  <div className="text-xs opacity-70">Blood Pressure</div>
                  <div className="font-semibold">{patientData.bloodPressure || "140/90"}</div>
                </div>
              </div>

              <div className="bg-slate-800 p-3 rounded-xl flex items-center">
                <div className="w-9 h-9 bg-slate-600 rounded-lg flex items-center justify-center mr-3">💓</div>
                <div>
                  <div className="text-xs opacity-70">Heart Rate</div>
                  <div className="font-semibold">{patientData.heartRate || "110"} bpm</div>
                </div>
              </div>
              ...
              <div className="bg-slate-800 p-3 rounded-xl flex items-center">
                <div className="w-9 h-9 bg-slate-600 rounded-lg flex items-center justify-center mr-3">💨</div>
                <div>
                  <div className="text-xs opacity-70">Oxygen Saturation</div>
                  <div className="font-semibold">{patientData.oxygenSaturation || "94"}%</div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Action Buttons */}
        <div className="fixed bottom-0 left-0 right-0 p-5 bg-slate-800 space-y-3">
          <Button
          ...
          <Link href="/">
            <Button
              variant="outline"
              className="w-full py-4 text-lg font-semibold rounded-2xl border-slate-600 text-white hover:bg-slate-700"
            >
